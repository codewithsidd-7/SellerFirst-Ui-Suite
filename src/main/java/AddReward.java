...
public class AddReward {
    public static void main(String[] args) throws InterruptedException {
        ...
        //Handling Reasons dropdown --ng-select error
//        WebElement nddown = driver.findElement(By.xpath("/html/body/anms-root/div/mat-sidenav-container/mat-sidenav-content/div/div/div[2]/add-points/div/div/div/mat-card/mat-card-content/form/div[2]/div[1]/div/div/ng-select"));
//        Select select = new Select(nddown);
//        select.selectByValue("hilo");
//        select.selectByIndex(3);

        driver.findElement(By.xpath("/html/body/anms-root/div/mat-sidenav-container/mat-sidenav-content/div/div/div[2]/add-points/div/div/div/mat-card/mat-card-content/form/div[2]/div[1]/div/div/ng-select")).click();
        driver.findElement(By.xpath("/html/body/anms-root/div/mat-sidenav-container/mat-sidenav-content/div/div/div[2]/add-points/div/div/div/mat-card/mat-card-content/form/div[2]/div[1]/div/div/ng-select/ng-dropdown-panel/div/div[2]/div[3]")).click();

        //Calender Start Date
        driver.findElement(By.xpath("/html/body/anms-root/div/mat-sidenav-container/mat-sidenav-content/div/div/div[2]/add-points/div/div/div/mat-card/mat-card-content/form/div[2]/div[3]/div[1]/mat-form-field/div/div[1]/div[2]")).click();
        driver.findElement(By.className("mat-calendar-body-today")).click();

        //Calender Start Date
        driver.findElement(By.xpath("/html/body/anms-root/div/mat-sidenav-container/mat-sidenav-content/div/div/div[2]/add-points/div/div/div/mat-card/mat-card-content/form/div[2]/div[3]/div[2]/mat-form-field/div/div[1]/div[2]/mat-datepicker-toggle/button")).click();
        driver.findElement(By.className("mat-calendar-body-today")).click();
