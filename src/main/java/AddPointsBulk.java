...
public class AddPointsBulk {
    public static void main(String[] args) throws InterruptedException {
        ...
        //Add points bulk button
        driver.findElement(By.xpath("/html/body/anms-root/div/mat-sidenav-container/mat-sidenav-content/div/div/div[2]/reward-points/div/div/div/mat-card[1]/div/div/button[2]")).click();
